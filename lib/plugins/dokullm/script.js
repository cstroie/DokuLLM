...
(function() {
    ...
    function addLLMTools() {
        ...
        // Create a separate toolbar for custom prompt
        console.log('DokuLLM: Creating custom prompt toolbar');
        const customPromptToolbar = document.createElement('div');
        customPromptToolbar.id = 'llm-custom-prompt-toolbar';
        customPromptToolbar.className = 'toolbar';
        
        // Add custom prompt input
        console.log('DokuLLM: Adding custom prompt input');
        ...
        customPromptToolbar.appendChild(customPromptContainer);
        
        // Insert custom prompt toolbar after the main toolbar
        toolbar.parentNode.insertBefore(customPromptToolbar, toolbar.nextSibling);
    ...
    function processText(action) {
        ...
        .then(data => {
            ...
            if (selectedText) {
                ...
                editor.innerHTML = metadata + data.result.replace(/\n/g, '<br>');
            }
        })
        .catch(error => {
